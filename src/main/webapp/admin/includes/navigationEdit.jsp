...
<div class="form-group">
	<span>
 	...
 	<span>
     	<button class = "btn btn-link" type="button" onclick="window.history.back()" data-toggle="tooltip" title="Cancels adding the Navigation, and refreshes this webpage.">Cancel</button>
   	</span>
</div> 