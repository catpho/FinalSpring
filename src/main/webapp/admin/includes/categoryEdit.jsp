<h1 class="page-header">Category Edit</h1>
 ...
 <div class="form-group col-xs-12 col-md-6">
	 ...
	 <input type="text" class="form-control" id="categoryDescription" autofocus required>     
 </div>
 <div class="form-group col-xs-12 col-md-6">
...
<div class="form-group">
	<span>
 	...
 	<span>
     	<button class = "btn btn-link" type="button" onclick="window.location.back())" data-toggle="tooltip" title="Cancels updating this category, and refreshes this webpage.">Cancel</button>
   	</span>
</div> 